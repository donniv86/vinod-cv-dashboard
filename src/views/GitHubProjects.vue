          ...
          <div class="flex flex-col lg:flex-row items-center justify-between">
            <div class="text-center lg:text-left">
              ...
              <p class="text-xl lg:text-2xl mb-6 text-white/90 font-medium" style="text-shadow: 0 0 8px rgba(255, 255, 255, 0.6);">
                Technical Skills & Open Source
              </p>
              <p class="text-lg mb-8 text-white/80 font-light" style="text-shadow: 0 0 5px rgba(255, 255, 255, 0.4);">
                11 repositories showcasing AI/ML, RAG systems, and computational chemistry expertise
              </p>
            </div>
            <div class="text-center lg:text-right mt-8 lg:mt-0">
              <div class="text-6xl lg:text-8xl font-black text-white/90 mb-2" style="text-shadow: 0 0 15px rgba(255, 255, 255, 0.7);">11</div>
              <div class="text-xl text-white/80 font-medium" style="text-shadow: 0 0 8px rgba(255, 255, 255, 0.6);">Repositories</div>
            </div>
          </div>
        </div>
